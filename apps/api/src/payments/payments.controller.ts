...
export const createPayment = async (req: AuthRequest, res: Response): Promise<void> => { sendSuccess(res, await service.create(req.body), 'Payment created', 201); };
export const updatePayment = async (req: AuthRequest, res: Response): Promise<void> => { sendSuccess(res, await service.update(req.params['id'] as string, req.body), 'Payment updated'); };
