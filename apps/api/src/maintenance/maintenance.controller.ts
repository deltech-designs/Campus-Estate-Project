...
import type { CreateMaintenanceDto } from './dtos/create-maintenance.dto';
import type { UpdateMaintenanceDto } from './dtos/update-maintenance.dto';
...
export const createMaintenance = async (req: AuthRequest, res: Response): Promise<void> => { const data = await service.create(req.body as CreateMaintenanceDto); sendSuccess(res, data, 'Maintenance request created', 201); };
export const updateMaintenance = async (req: AuthRequest, res: Response): Promise<void> => { const data = await service.update(req.params['id'] as string, req.body as UpdateMaintenanceDto); sendSuccess(res, data, 'Maintenance request updated'); };
