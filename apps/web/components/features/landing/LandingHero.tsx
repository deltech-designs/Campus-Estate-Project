...
export function LandingHero() {
  return (
    <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
      ...
      <div className="inline-flex items-center gap-2.5 px-4 py-1.5 bg-[var(--color-surface-raised)] border border-[var(--color-border)] rounded-full shadow-[var(--shadow-card)] mb-8 hover:border-[var(--color-primary)]/20 transition-all duration-300 pointer-events-none group">
      ...
      {/* ─── Hero Headlines ────────────────────────────────────────────────── */}
      <h1 className="text-4xl sm:text-7xl font-extrabold text-[var(--color-text-primary)] font-display leading-[1.08] tracking-tight max-w-5xl mx-auto">
      ...
      {/* ─── Hero Description ──────────────────────────────────────────────── */}
      <p className="mt-8 text-base sm:text-lg text-[var(--color-text-secondary)] max-w-2xl mx-auto font-normal leading-relaxed">
      ...
      <div className="mt-12 flex flex-wrap items-center justify-center gap-x-8 gap-y-4 text-xs font-bold text-[var(--color-text-secondary)] border-t border-[var(--color-border)] pt-8 max-w-3xl mx-auto">
        
        <div className="flex items-center gap-2 group cursor-pointer hover:text-[var(--color-text-primary)] transition-colors">
